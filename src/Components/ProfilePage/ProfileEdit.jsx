      ...
      >
        ...
        >
          <input
            ...
            placeholder="Name"
            className="!bg-[#1E1E1E] !text-white p-2 w-full outline-none focus:bg-[var(--black-700)] hover:bg-[var(--black-700)] active:bg-[var(--black-700)] border-none h-11 text-[var(--white-600)]"
          />
        </Form.Item>
        ...
        >
          <input
            ...
            type="email"
            placeholder="Email"
            className="cursor-not-allowed !bg-[#1E1E1E] !text-white p-2 w-full outline-none focus:bg-[var(--black-700)] hover:bg-[var(--black-700)] active:bg-[var(--black-700)] border-none h-11 text-[var(--white-600)]"
          />
        </Form.Item>
