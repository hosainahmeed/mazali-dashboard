    ...
    <>
      ...
      <div className="max-w-[700px] mx-auto  p-4 rounded-md">
        <div className="w-full center-center">
          <div onClick={() => document.getElementById("fileInput")?.click()} className="w-24 h-24 border-2 border-white p-1 cursor-pointer rounded-full relative">
            <img
            ...
            {tab === "Edit Profile" && (
              ...
              >
                <FaEdit size={24} className="text-white cursor-pointer" />
              </button>
            )}
      ...
      <div className="w-full center-center my-3">
        {Tabs.map((item) => (
          <Button
            ...
            className={`${
              item === tab
                ? "!border-0 !rounded-none !text-[#00D5A9] !border-b-1 !border-white !bg-transparent"
                : "!border-0 !rounded-none !text-white !border-b-1 !border-white !bg-transparent"
            }`}
            onClick={() => setTab(item)}
          >
            {item}
